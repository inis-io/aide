...
func issueManifest(payload ManifestPayload, seed []byte) (Manifest, error) {
	...
	return Manifest{Version: LicenceProtocol.EnvelopeVersion, Algorithm: LicenceProtocol.Algorithm, Payload: payload, Signature: signature}, nil
}
...
func (this *Client) VerifyManifest(raw json.RawMessage) (*Manifest, error) {
	...
	if manifest.Version != LicenceProtocol.EnvelopeVersion || manifest.Algorithm != LicenceProtocol.Algorithm ||
		!LicenceProtocol.Licence.VerifyRaw(rawPayload, manifest.Signature, publicKey) {
...
func (this *Client) verifyArtifact(artifact ManifestArtifact, version string) bool {
	...
	return LicenceProtocol.Licence.VerifyRaw(payloadBytes, artifact.Signature, publicKey)
}
...
func (this *Client) ReportUpgrade(ctx context.Context, report UpgradeReport) (string, error) {
	...
	this.updateClockOffset(response.ServerTime)
	if response.Status != LicenceProtocol.StatusValid {
